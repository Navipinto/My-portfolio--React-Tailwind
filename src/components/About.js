...
function About() {
  return (
    ...
    >
      <div className=" space-x-5 flex flex-col justify-betweens items-center lg:flex-row w-full lg:px-16">
        <div className=" w-2/3 sm:w-[300px] md:w-[400px] lg:w-[2800px]">
          <img className="rounded-lg" src={aboutpic} alt="aboutpic" />
        </div>
        <div className="flex flex-col justify-center  md:ps-4 md:mx-0 md:items-center lg:items-start items-center w-fits ">
          ...
          <p className="w-fit mt-2 text-center lg:text-start md:w-4/5">
